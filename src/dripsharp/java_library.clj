...
(defn- declarative-shared-field-node
  [element occurrence target-element target-node]
  (when (mapping-registry/registry-entry
         declarative-shared-mappings
         (:key occurrence))
    (:node
