(ns dripsharp.pkl.java-body
  ...
  dripsharp.java-translate remains product-neutral. Structural rules consume
...
(defn- binary-node [services ^CtBinaryOperator element children]
  (let [kind (str (.getKind element))
    ...
    (cond
      ...
      (invoke (raw "global::DripSharp.Runtime.JavaCompat.IsSet") [left])
      ...
      (invoke (raw "global::DripSharp.Runtime.JavaCompat.Concat") [left right])
...
(defn- compat-call [name arguments]
  (invoke (raw (str "global::DripSharp.Runtime.JavaCompat." name)) arguments))
...
(defn- invocation-node [context services ^CtInvocation element children]
  (let [key (executable-key context element)
        ...
        (case key
          ...
          "executable:java.lang.Boolean#toString()" (compat-call "StringValueOf" [target])
          "executable:java.lang.Byte#toString()" (compat-call "StringValueOf" [target])
          "executable:java.lang.Short#toString()" (compat-call "StringValueOf" [target])
          "executable:java.lang.Integer#toString()" (compat-call "StringValueOf" [target])
          "executable:java.lang.Long#toString()" (compat-call "StringValueOf" [target])
          "executable:java.lang.Float#toString()" (compat-call "StringValueOf" [target])
          "executable:java.lang.Double#toString()" (compat-call "StringValueOf" [target])
          "executable:java.lang.Character#toString()" (compat-call "StringValueOf" [target])
          ...
          "executable:java.util.regex.Pattern#flags()" (compat-call "RegexFlags" [target])
          "executable:java.util.regex.Pattern#split(java.lang.CharSequence)"
          (compat-call "RegexSplit" [target (arg 0) (raw "0")])
          "executable:java.util.regex.Pattern#split(java.lang.CharSequence,int)"
          (compat-call "RegexSplit" (into [target] args))
          "executable:java.util.regex.Pattern#quote(java.lang.String)" (compat-call "QuoteRegex" args)
     ...
     :emit (fn [{:keys [context ^CtFieldRead element children]}]
             (let [target-element (.getTarget element)
                   ...
                   constant (case key
                              ...
                              "field:java.util.regex.Pattern#UNIX_LINES" (raw "1")
                              "field:java.util.regex.Pattern#CASE_INSENSITIVE" (raw "2")
                              "field:java.util.regex.Pattern#COMMENTS" (raw "4")
                              "field:java.util.regex.Pattern#MULTILINE" (raw "8")
                              "field:java.util.regex.Pattern#LITERAL" (raw "16")
                              "field:java.util.regex.Pattern#DOTALL" (raw "32")
                              "field:java.util.regex.Pattern#UNICODE_CASE" (raw "64")
                              "field:java.util.regex.Pattern#CANON_EQ" (raw "128")
                              "field:java.util.regex.Pattern#UNICODE_CHARACTER_CLASS" (raw "256")
