...
using Vibeformer.Runtime;

internal static class Program
{
    private const string ObservationHeader = "VIBEFORMER_RAWHTTP_OBSERVATIONS_V1";
    private const string ProvenanceHeader = "VIBEFORMER_RAWHTTP_PACKAGE_PROVENANCE_V1";
