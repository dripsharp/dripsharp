...
upstream JVM. Its 53 behavior families distinguish 49 directly comparable JVM
families from four .NET-specific assembly, embedded-resource, path, and disposal
adaptations; 12 unimplemented families remain explicitly pending in scope. A
package-reference-only .NET consumer independently exercises 17 normalized
...
resources, canonical policy checks, errors, and ownership boundaries. The 17
