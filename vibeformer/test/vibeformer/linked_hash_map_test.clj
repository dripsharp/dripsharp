(ns vibeformer.linked-hash-map-test
...
(defn- fixture-path []
  (paths/resolve-path (paths/workspace-root)
                      "vibeformer" "test" "fixtures" "linked_hash_map"
...
(def ^:private configuration
  {:schema-version 1
   ...
   :package {:id "Vibeformer.LinkedHashMap.Fixture"
             ...
             :authors "Vibeformer"
             :tags "vibeformer java linkedhashmap fixture"
             :project-url "https://example.invalid/vibeformer"
             :repository-url "https://example.invalid/vibeformer.git"
             :repository-type "git"}
...
(defn- consumer-project [target-framework]
  (str "<Project Sdk=\"Microsoft.NET.Sdk\">\n"
       ...
       "  </PropertyGroup>\n"
       "  <ItemGroup>\n"
       "    <PackageReference Include=\"Vibeformer.LinkedHashMap.Fixture\" "
       "Version=\"1.0.0-task\" />\n"
       "  </ItemGroup>\n"
       "</Project>\n"))
...
(deftest resolved-linked-hash-map-semantics-match-java-through-a-package-only-consumer
  (let [workspace (paths/workspace-root)
        source (fixture-path)
        root (Files/createTempDirectory "vibeformer-linked-hash-map"
    ...
    (testing "the resolved fixture exercises helper dispatch and subclass eviction"
      ...
      (is (str/includes? generated
                         "new global::Vibeformer.Runtime.JavaLinkedHashMap<string, string>(8, 0.75F, true)")))
