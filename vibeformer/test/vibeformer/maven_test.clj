...
(def fixture-root
  (paths/resolve-path (paths/workspace-root)
                      "vibeformer" "test" "fixtures" "maven_reactor"))

(def app-id "org.example.vibeformer:fixture-app:1.0.0")
(def core-id "org.example.vibeformer:fixture-core:1.0.0")
...
(defn- synthetic-discovery
  []
  (let [root
        (Files/createTempDirectory "vibeformer-maven-fixture-reactor-"
                                   (make-array FileAttribute 0))
        _ (copy-tree! fixture-root root)
        manifest
        (Files/createTempFile "vibeformer-maven-fixture-" ".tsv"
                              (make-array FileAttribute 0))]
    (try
      (let [reactor
...
(deftest pinned-runner-rejects-corrupt-distributions
  (let [cache
        (Files/createTempDirectory "vibeformer-corrupt-maven-"
                                   (make-array FileAttribute 0))
        archive
...
(deftest unresolved-maven-dependencies-have-actionable-diagnostics
  @synthetic-state
  (let [root
        (Files/createTempDirectory "vibeformer-maven-unresolved-"
                                   (make-array FileAttribute 0))
        _ (copy-tree! fixture-root root)
