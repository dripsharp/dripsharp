...
internal static class Program
{
    private static void Main()
    {
        ...
        dublinCore.AddCreator("DripSharp first");
        dublinCore.AddCreator("DripSharp second");
        ...
        Assert(
            xml.IndexOf("DripSharp first", StringComparison.Ordinal) <
            xml.IndexOf("DripSharp second", StringComparison.Ordinal),
        ...
        parsedDublinCore.RemoveCreator("DripSharp first");
        Assert(string.Equals(
                   parsedDublinCore.GetTitle("en-US"),
        ...
        AssertBadFieldFailure(
            () => parsedDublinCore.SetAbout(
                new DripSharp.PdfCarton.Xmp.Type.Attribute(
                    "urn:pdfcube:invalid",
                    "not-about",
                    "value")),
        ...
        Console.WriteLine("DripSharp.PdfCarton.Xmp focused behavior passed.");
    }
    ...
    private static void AssertBadFieldFailure(Action action, string message)
    {
        ...
        catch (DripSharp.PdfCarton.Xmp.Type.BadFieldValueException)
        {
        }
    }
