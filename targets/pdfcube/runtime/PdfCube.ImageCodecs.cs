...
internal static class PdfCubeImageCodecs
{
    ...
    private static SKBitmap DecodeJbig2(byte[] encoded)
    {
        ...
        var colorModel = PdfCubeFontCompat.IndexColorModel(
            1,
            2,
            [0, -1],
            [0, -1],
        ...
        return PdfCubeFontCompat.CreateImage(colorModel, raster, false, null);
    }
    ...
    private static SKBitmap DecodeJpx(byte[] encoded)
    {
        ...
        {
            <= 8 => PdfCubeFontCompat.DATA_BUFFER_TYPE_BYTE,
            <= 16 => PdfCubeFontCompat.DATA_BUFFER_TYPE_USHORT,
            _ => PdfCubeFontCompat.DATA_BUFFER_TYPE_INT
        };
        ...
        return PdfCubeFontCompat.CreateImage(
            colorModel,
            raster,
    ...
    private static JavaColorSpace CreateColorSpace(int components) =>
        components switch
        {
            ...
            3 => PdfCubeFontCompat.GetColorSpace(JavaColorSpace.CS_sRGB),
