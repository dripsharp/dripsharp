...
{
    const string ResultMagic = "DRIPSHARP_LANGUAGE_SNIPPET_PACKAGE_RESULTS_V1";
    const string WorkerMagic = "DRIPSHARP_LANGUAGE_SNIPPET_WORKER_V1";
    ...
    {
        Type compat = typeof(Evaluator).Assembly.GetType("DripSharp.Runtime.JavaCompat", true)!;
