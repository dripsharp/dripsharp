...
adapting it to DripSharp's neutral Java project input. Gradle builds use their
...
DripSharp does not require a Kotlin PSI or Analysis API frontend and does not
...
This is a language-scope decision, not a reduction in DripSharp's generality:
