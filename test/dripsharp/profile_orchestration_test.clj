(ns dripsharp.profile-orchestration-test
...
(defn- temp-directory []
  (Files/createTempDirectory "dripsharp-profile-orchestration"
...
(defn- fixture! []
  (let [workspace (paths/workspace-root)
        ...
        surface (write-file!
                 ...
                 (str "DRIPSHARP_JAVA_LIBRARY_PUBLIC_SURFACE_V1\n"
                      "surface\t"
        ...
        (write-file!
         ...
         (str "# DRIPSHARP_DOTNET_ACCESSIBLE_CONTRACT_V1\n"
        ...
        {:schema-version 1
         ...
         :public-surface
         {:strategy 'dripsharp.java-library/public-surface-strategy
...
(deftest complete-independent-profile-selects-an-explicit-pinned-public-contract
  (let [workspace (paths/workspace-root)
    ...
    (is (= 'dripsharp.java-library/rule-bundle
