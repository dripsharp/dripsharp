...
(deftest workspace-discovery-does-not-require-the-pkl-checkout
  (let [root (Files/createTempDirectory "dripsharp-non-pkl-workspace"
                                        (make-array FileAttribute 0))
        nested (paths/resolve-path root "validation" "rawhttp-core")
        deps (paths/resolve-path root "deps.edn")]
